...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('assets/admin/img/Fadly.png') }}" rel="icon" />
        ...
        <div class="container-fluid" data-aos="fade-up">
            <div class="row justify-content-center">
                <div
                    ...
                    <h1>Hello Wellcome To My Website Prototype</h1>
                    <h2>
                        Kami Adalah Start Up Baru di bidang Teknologi di Tahun 2024
                    </h2>
                    <div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="150">
                        <img src="{{ asset('assets/landing/img/about.jpg') }}" class="img-fluid" alt="HERO" />
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
                        <h3>Kami adalah perusahan start up yang berdiri di tahun 2024 dan menyediakan jasa seperti di
                            bawah</h3>
                        <p class="fst-italic">
        ...
        <section id="counts" class="counts">
            <div class="container">
                <div class="row counters">
                    ...
                    <div class="col-lg-3 col-6 text-center">
                        <span data-purecounter-start="0" data-purecounter-end="1999" data-purecounter-duration="1"
                            class="purecounter"></span>
                ...
                <div class="row gy-4">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in"
                        ...
                        <div class="icon-box iconbox-blue">
                            ...
                            <p>
                                A web developer's job is to create websites. While their primary role is to ensure the
                                website is visually appealing and easy to navigate, many web developers are also
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in"
                        ...
                        <div class="icon-box iconbox-orange">
                            ...
                            <p>
                                Definition. An Android Developer is a Software Developer who specializes in designing
                                and building mobile-based applications using the Android operating system.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in"
                        ...
                        <div class="icon-box iconbox-red">
                            ...
                            <p>
                                Web design involves creating the visual elements and layout of a website, while coding
                                involves translating these designs into a functional website using programming languages
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in"
                        ...
                        <div class="icon-box iconbox-teal">
                            ...
                            <h4><a href="">Technology Consultant</a></h4>
                            <p>
                                IT consultant is a profession that is tasked with helping companies or clients who use
                                their services, to solve problems in the company's information technology system. An IT
                                consultant will provide advice and input related to technology so that the IT system
                                runs efficiently and optimally.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <iframe class="mb-4 mb-lg-0"
                            src="{{ asset('https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.519071751554!2d110.79098277605478!3d-7.73463287666435!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a39de666bd409%3A0xa6e26d94f32be2e!2sCV.%20DODOLAN%20INFORMATIKA%20TEKNOLOGI!5e0!3m2!1sen!2sid!4v1719294047315!5m2!1sen!2sid') }}"
